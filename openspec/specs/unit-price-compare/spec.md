# unit-price-compare Specification

## Purpose

Defines the unit-price comparison feature: how users add products with a price and quantity, how unit prices are computed and displayed, how the list is ordered and named, how the lowest unit price is highlighted, and how products are removed from the list.
