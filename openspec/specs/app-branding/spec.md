...
Defines the user-visible branding of the application: its display name across all platform surfaces, and the launcher icon artwork shown on device home screens and app drawers.
